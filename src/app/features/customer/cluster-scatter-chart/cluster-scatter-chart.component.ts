...
@Component({
  selector: 'app-cluster-scatter-chart',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './cluster-scatter-chart.component.html',
  styleUrl: './cluster-scatter-chart.component.css'
})
export class ClusterScatterChartComponent implements AfterViewInit {
